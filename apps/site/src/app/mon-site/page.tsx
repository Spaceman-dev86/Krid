        ...
        <Container className="py-10 md:py-14">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <div className="grid gap-5">
              <SectionHeading eyebrow="Explication" title="Une vitrine simple, puis une app" />
              <p className="text-sm text-black/70 sm:text-base">
                Commence avec un site simple pour vendre tes programmes et évoluer vers une app.
              </p>

              <div className="grid gap-3">
                <Card>
                  <div className="text-sm font-extrabold text-[#341c44]">Vente en ligne</div>
                  <div className="mt-1 text-sm text-black/70">Catalogue clair, paiement, et parcours de conversion.</div>
                </Card>
                <Card>
